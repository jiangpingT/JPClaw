---
name: coding-agent
description: 代码助手集成工具。通过后台进程运行 Codex CLI、Claude Code、OpenCode 或 Pi Coding Agent，支持编程任务自动化控制。支持一次性任务执行、后台运行、进程监控、输入提交、PR审查、并行修复、工作树管理等。适用于"运行Codex"、"用Claude Code XX"、"代码审查"、"修复Issue"、"自动编程"等查询。必须使用 PTY 模式，需要在 git 仓库中运行。
metadata:
  {
