---
name: discord
description: Discord 机器人控制工具。通过 Discord bot 发送消息、添加反应、发送贴纸、创建投票、管理线程/置顶/搜索、创建/编辑/删除频道和分类、上传emoji/贴纸、查看成员/角色/频道信息、设置bot状态、执行管理操作（超时/踢出/封禁）。适用于"发送Discord消息"、"创建Discord投票"、"上传emoji"、"管理频道"、"搜索消息"等查询。需要配置 Discord bot token。
