---
name: canvas
description: HTML 内容展示工具。在连接的 OpenClaw 节点（Mac 应用/iOS/Android）上展示 HTML 内容。支持显示游戏、可视化、仪表盘、交互式演示。支持展示、隐藏、导航、执行 JavaScript、截图、实时重载。适用于"显示XX内容"、"展示HTML"、"Canvas XX"、"在设备上显示XX"等查询。需要配置 Canvas Host 服务器。
---
