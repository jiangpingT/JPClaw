---
name: gifgrep
description: GIF 搜索下载工具。通过 CLI/TUI 搜索 GIF 提供商（Tenor/Giphy），下载结果并提取静态帧/帧表。支持搜索、TUI 浏览、下载、提取静帧、生成帧表网格。适用于"搜索GIF"、"下载GIF"、"提取GIF帧"、"GIF预览"等查询。支持 Kitty/Ghostty 终端预览。
