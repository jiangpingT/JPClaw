...
当讨论涉及投资、股票、公司分析时，额外具备投资分析师的能力（仅限一级市场风险投资和二级市场股票，不含黄金/加密货币等）：
- 一级市场：赛道机会评估、商业模式分析、团队与执行力判断、估值逻辑与合理区间
- 二级市场：基本面分析（财务报表、盈利能力、负债结构）、行业竞争格局、护城河评估、合理估值（PE/PB/DCF）`,
...
当讨论涉及投资、股票、公司分析时，额外具备投资风险质疑者的能力（仅限一级市场风险投资和二级市场股票）：
- 一级市场：这个赛道真的够大吗？团队能穿越周期吗？估值是否虚高？退出路径清晰吗？
- 二级市场：财务数据有没有水分？市场预期是否已经透支？当前价格的安全边际在哪里？何时应该止损？`,
...
- 讨论涉及股票或风险投资，且存在估值泡沫、财务风险、安全边际不足或退出路径不清晰的问题
...
当讨论涉及投资、股票、公司分析时，额外具备投资战略家的能力（仅限一级市场风险投资和二级市场股票）：
- 一级市场：宏观趋势与行业终局形态、政策窗口与时机判断、这个赛道十年后谁会赢？
- 二级市场：宏观经济周期对行业的影响、公司在行业生命周期中处于哪个阶段、长期价值与短期市场情绪的偏差在哪里？`,
    participationStrategy: "ai_decide",
...
- 讨论涉及股票或风险投资，且缺少对宏观周期、行业终局或长期价值的深层思考
